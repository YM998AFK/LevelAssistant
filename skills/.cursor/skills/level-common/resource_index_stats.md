...
# 2D精灵 - 按分类查询
rg '"sprite_category":"交互/剧情选项按钮"' .cursor/skills/level-common/resource_index.jsonl
rg '"sprite_category":"弹窗/' .cursor/skills/level-common/resource_index.jsonl
rg '"sprite_category":"UI/' .cursor/skills/level-common/resource_index.jsonl
rg '"sprite_category":"2D动画/' .cursor/skills/level-common/resource_index.jsonl
# 2D精灵 - 多帧动画（有 fps 字段）
rg '"fps":24' .cursor/skills/level-common/resource_index.jsonl
# 2D精灵 - 按时长筛选（超过1秒）
rg '"duration_s":[1-9]' .cursor/skills/level-common/resource_index.jsonl
```
