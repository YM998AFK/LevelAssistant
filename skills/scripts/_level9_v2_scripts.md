# a89f0fad-7509-48be-9ee0-d3d98f3575f3.ws
...
### scene/control/BlockScript [BlockScript] in <BlockScript> (9 fragments)
--- fragment #0 ---
WhenGameStarts()
  SetVar('cid', '2')
  Hide({})
...
WhenReceiveMessage('初始化')
  ...
  If(    Or(      IsEqual(        Variable('cid'), {}, '1'), {},       IsEqual(        Variable('cid'), {}, '2')))
    ListAdd('12', 'cin_cut')
    ListAdd('8', 'cin_cut')
    ListAdd('15', 'cin_cut')
    ListAdd('20', 'cin_cut')
